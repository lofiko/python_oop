...
class PrintedBook(Book):
    ...
    def display(self) -> str:
        return f"{self._title} — {self._author}, {self._year} | Издательство: {self._publisher}, {self._price:.2f} руб."

    def score(self) -> float:
        return round(self._pages / self._price, 2)
...
class Ebook(Book):
    ...
    def display(self) -> str:
        return f"{self._title} — {self._author}, {self._year} | Формат: {self._file_format}, {self._price:.2f} руб."
...
class AudioBook(Book):
    ...
    def display(self) -> str:
        return f"{self._title} — {self._author}, {self._year} | Чтец: {self._narrator}, {self._price:.2f} руб."

    def score(self) -> float:
        return round(self._duration / self._price, 2)